...
./scripts/glslc ./assets/shaders/entity.vert -o assets/shaders/spv/entity_vert.spv
./scripts/glslc ./assets/shaders/entity.frag -o assets/shaders/spv/entity_frag.spv
