...
namespace Poulpe
{
    ...
    public:
        ...
        void inline addRenderer(IRendererAdapter* renderer) override { m_Renderer = renderer; }
        void clear() override;
        ...
        inline uint32_t getInstancedCount() const override { return m_Entities.size(); }
        ...
        inline EntityNode const * getWorldNode() const { return m_WorldNode.get(); }
