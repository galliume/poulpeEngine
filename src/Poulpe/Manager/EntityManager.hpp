...
namespace Poulpe
{
    ...
    public:
        ...
        void addHUD(std::vector<std::unique_ptr<Mesh>> hud) override { m_HUD = std::move(hud); }
        void clear() override;
        ...
        inline void setSkybox(std::unique_ptr<Mesh> skybox) override { m_Skybox = std::move(skybox); }
        ...
        std::vector<std::unique_ptr<Mesh>> getHUD() override { return m_HUD; }
    ...
    private:
        ...
        std::vector<std::unique_ptr<Mesh>> m_HUD = {};
