...
namespace Poulpe
{
    ...
    public:
        ...
        virtual inline std::vector<Entity*> getEntities() = 0;
        virtual inline void setSkybox(std::unique_ptr<Mesh> skybox) = 0;
        ...
        virtual void addHUD(std::vector<std::unique_ptr<Mesh>> hud) = 0;
        virtual std::vector<std::unique_ptr<Mesh>> getHUD() = 0;
    };
}
