...
namespace Poulpe
{
  ...
  struct QuadVertex
  {
    ...
    static std::array<VkVertexInputAttributeDescription,  5> getAttributeDescriptions()
    {
      ...
      attributeDescriptions[1].location = 1;
      attributeDescriptions[1].format = VK_FORMAT_R32G32B32_SFLOAT;
      attributeDescriptions[1].offset = offsetof(QuadVertex, normal);

      attributeDescriptions[2].binding = 0;
      attributeDescriptions[2].location = 2;
      attributeDescriptions[2].format = VK_FORMAT_R32G32_SFLOAT;
      attributeDescriptions[2].offset = offsetof(QuadVertex, texture_coord);

      attributeDescriptions[3].binding = 0;
      attributeDescriptions[3].location = 3;
      attributeDescriptions[3].format = VK_FORMAT_R32G32B32A32_SFLOAT;
      attributeDescriptions[3].offset = offsetof(QuadVertex, tangent);

      attributeDescriptions[4].binding = 0;
      attributeDescriptions[4].location = 4;
      attributeDescriptions[4].format = VK_FORMAT_R32G32B32A32_SFLOAT;
      attributeDescriptions[4].offset = offsetof(QuadVertex, color);
  ...
  /*  bool operator==(const QuadVertex& other) const
    ...
    QuadVertex operator-(QuadVertex const& rhs)
    {
      QuadVertex v = rhs;
      v.pos = rhs.pos - pos;
