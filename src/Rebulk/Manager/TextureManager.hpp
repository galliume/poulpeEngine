...
namespace Rbk
{
    ...
    public:
        ...
        virtual std::function<void()> Load(std::condition_variable& cv) override;
        virtual std::function<void()> LoadSkybox(const std::string& skybox, std::condition_variable& cv) override;
