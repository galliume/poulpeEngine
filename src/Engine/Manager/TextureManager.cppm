...
namespace Poulpe
{
  ...
  public:
    ...
    void clear();
    Texture & getSkyboxTexture() { return _textures.at(_skybox_name); }
    Texture getSkyboxTexture() const & { return _textures.at(_skybox_name); }
    ...
    Texture & getTerrainTexture() { return _textures.at(_terrain_name); }
    Texture & getWaterTexture() { return _textures.at(_water_name); }
